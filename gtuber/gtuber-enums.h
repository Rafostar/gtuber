 ...
 * @GTUBER_STREAM_MIME_TYPE_CAPTION_VTT: text/vtt.
 * @GTUBER_STREAM_MIME_TYPE_CAPTION_TTML: application/ttml+xml.
 */
typedef enum
{
  ...
  GTUBER_STREAM_MIME_TYPE_CAPTION_VTT = 101,
  GTUBER_STREAM_MIME_TYPE_CAPTION_TTML = 102,
} GtuberStreamMimeType;
